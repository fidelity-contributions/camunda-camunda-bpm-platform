...
public class TelemetryReporterTest {
  ...
  public void shouldSendTelemetryWithApplicationServerInfo() {
    ...
    configuration.getTelemetryRegistry().setApplicationServer(new ApplicationServer(applicationServerVersion));

    Data expectedData = adjustTestDataWithProductVersionAndAppServerInfo(applicationServerVersion);
  ...
  protected Data adjustTestDataWithProductVersionAndAppServerInfo(String applicationServerVersion) {
    Data telemetryData = configuration.getTelemetryData();

    Product product = telemetryData.getProduct();
